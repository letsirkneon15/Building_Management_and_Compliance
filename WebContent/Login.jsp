							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form class="user" action="${pageContext.request.contextPath}/Login?action=signin" method="post">
										...
										<div class="form-group">
											<div class="custom-control custom-checkbox small">
												<input type="checkbox" class="custom-control-input"
													...
													class="custom-control-label" for="customCheck" style="font-size:12px">Remember
													Me</label>
											</div>
										</div>
										...
										<div class="text-center">
											<a class="small" href="${pageContext.request.contextPath}/CreateAccount" style="font-size:12px">Create an Account!</a>
										</div>
									</form>
								</div>
							</div>
