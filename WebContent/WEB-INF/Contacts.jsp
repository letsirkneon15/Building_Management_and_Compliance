									...
									<d:forEach var="b" items="${contactsArr}" varStatus="bIndex">
										<tr>
											...
											<td align="center"><a href="#editContacts"
												...
												data-recordid="${b.recordID}" data-name="${b.name}"
												data-type="${b.type}" data-company="${b.company}"
												data-phonenumber="${b.phoneNumber}"
												data-faxnumber="${b.faxNumber}"
												data-mobilenumber="${b.mobileNumber}"
												data-emailadd="${b.emailAdd}"> <img
											...
											<td align="center"><a href="#editContacts"
												data-toggle="modal" data-id="edtLink${bIndex.index}"
												data-buildingid="${b.buildingID}"
												data-recodid="${b.recordID}" data-name="${b.name}"
												data-type="${b.type}" data-company="${b.company}"
												data-phonenumber="${b.phoneNumber}"
												data-faxnumber="${b.faxNumber}"
												data-mobilenumber="${b.mobileNumber}"
											...
											<td align="center"><a href="#deleteContacts"
												...
												data-recordid="${b.recordID}"
												data-buildingid="${b.buildingID}"> <img
													src='images/delete.jpg' height=15 width=15>
											</a></td>
										</tr>
									</d:forEach>
								</tbody>
															...
															<div class="panel-body">
																...
																<div class="col-sm-6">
																	<label for="name">Name:</label> <input
																		class="form-control" name="crtCName" id="crtCName"
																		type="text" value="${crtCName}">
																</div>

																<!-- Type  -->
																<div class="col-sm-6">
																	<label for="type">Type:</label> <input
																		class="form-control" name="crtCType" id="crtCType"
																		type="text" value="${crtCType}">
																</div>
															</div>
														</div>
															...
															<div class="panel-body">
																...
																<div class="col-sm-6">
																	<label for="company">Company:</label> <input
																		class="form-control" name="crtCCompany"
																		id="crtCCompany" type="text" value="${crtCCompany}">
																</div>
																...
																<div class="col-sm-6">
																	<label for="phoneNumber">Phone Number:</label> <input
																		...
																		id="crtCPhoneNumber" type="text"
																		value="${crtCPhoneNumber}">
																</div>
															</div>
														</div>
															...
															<div class="panel-body">
																...
																<div class="col-sm-6">
																	<label for="faxNumber">Fax Number:</label> <input
																		class="form-control" name="crtCFaxNumber"
																		id="crtCFaxNumber" type="text"
																		value="${crtCFaxNumber}">
																</div>
																...
																<div class="col-sm-6">
																	<label for="mobileNumber">Mobile Number:</label> <input
																		...
																		id="crtCMobileNumber" type="text"
																		value="${crtCMobileNumber}">
																</div>
															</div>
														</div>
															...
															<div class="panel-body">
																...
																<div class="col-sm-6">
																	<label for="emailAdd">Email Address:</label> <input
																		class="form-control" name="crtCEmailAdd"
																		id="crtCEmailAdd" type="text" value="${crtCEmailAdd}">
																</div>
																<input class="form-control" name="crtCBuildingID"
																	id="crtCBuildingID" type="hidden"
																	value="${crtCBuildingID}">
															</div>
														</div>
													...
													<div class="panel-default">
														<div class="panel-body">
															...
															<div class="col-sm-6">
																<label for="faxNumber">Fax Number:</label> <input
																	class="form-control" name="crtCFaxNumber"
																	id="crtCFaxNumber" type="text" value="${crtCFaxNumber}">
															</div>
													...
													<div class="well">
														...
														<div class="panel-default">
															<div class="panel-body">
																...
																<div class="col-sm-6">
																	<label for="name">Name:</label> <input
																		class="form-control" name="edtCName" id="edtCName"
																		type="text" value="">
																</div>
																...
																<div class="col-sm-6">
																	<label for="type">Type:</label> <input
																		class="form-control" name="edtCType" id="edtCType"
																		type="text" value="">
																</div>
															</div>
														</div>
														...
														<div class="panel-default">
															<div class="panel-body">
																...
																<div class="col-sm-6">
																	<label for="company">Company:</label> <input
																		class="form-control" name="edtCCompany"
																		id="edtCCompany" type="text" value="">
																</div>
														...
														<div class="panel-default">
															<div class="panel-body">
																...
																<div class="col-sm-6">
																	<label for="faxNumber">Fax Number:</label> <input
																		class="form-control" name="edtCFaxNumber"
																		id="edtCFaxNumber" type="text" value="">
																</div>
														...
														<div class="panel-default">
															<div class="panel-body">
																...
																<div class="col-sm-6">
																	<label for="emailAdd">Email Address:</label> <input
																		class="form-control" name="edtCEmailAdd"
																		id="edtCEmailAdd" type="text" value="">
																</div>

																<input class="form-control" name="edtCRecordID"
																	id="edtCRecordID" type="hidden" value=""> <input
																	class="form-control" name="edtCBuildingID"
																	id="edtCBuildingID" type="hidden" value="">
															</div>
														</div>
								...
								<div class="modal-dialog" style="width: 50%">
									...
									<div class="modal-content">
										...
										<form
											...
											<input class="form-control" name="dltCRecordID"
												id="dltCRecordID" type="hidden" value=""> <input
												class="form-control" name="dltCBuildingID"
												id="dltCBuildingID" type="hidden" value="">
											<div class="modal-footer">
												<!-- Submit Button -->
												<button type="submit" class="btn btn-primary">
